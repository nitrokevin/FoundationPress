...
add_image_size( 'featured-small', 640, 350, true ); // name, width, height, crop
add_image_size( 'featured-medium', 800, 400, true );
add_image_size( 'featured-large', 1000, 600, true );
add_image_size( 'featured-xlarge', 1290, 715, true );
