...
<section class="style-article-container <?php echo $background ?>">
  ...
  <div class="style-article">
    ...
    <div class="right-bottom <?php echo $layout ?>">
      <div class="right-bottom-image" data-interchange="[<?php echo $bottom_small; ?>, small], [<?php echo $bottom_medium; ?>, medium], [<?php echo $bottom_large; ?>, large], [<?php echo $bottom_large; ?>, xlarge]" alt="<?php echo $bottom_medium['alt'] ?>">
	</div>
    </div>
